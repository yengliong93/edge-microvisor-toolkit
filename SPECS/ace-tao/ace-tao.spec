...
#
# Read: If neither macro exits, then add the default definition.
...
%changelog
* Wed May 29 2025 Swee Yee Fonn <swee.yee.fonn@intel.com> - 8.0.3-1
- Initial Edge Microvisor Toolkit import from Distributed Object Computing Group source (license: DOC). License verified.
- Imported from rpmbuild/ace-tao.spec.
