...
VALID_SOURCE_ATTRIBUTIONS = {
    "Intel":                          r'\n-\s+(Original version for Edge Microvisor Toolkit)( \(license: MIT\))?(\.|\n|$)',
    "Microsoft":                      r'\n-\s+(Original version for (CBL-Mariner|Azure Linux)|Initial (CBL-Mariner|Azure Linux|Edge Microvisor Toolkit) import from (CBL-Mariner|Azure Linux|Azure))( \(license: MIT\))?(\.|\n|$)',
    ...
    "Fedora (ISC)":                   r'\n-\s+Initial (Edge Microvisor Toolkit|CBL-Mariner|Azure Linux) import from Fedora \d+ \(license: ISC\)(\.|\n|$)',
    "Magnus Edenhill Open Source":    r'\n-\s+Initial (Edge Microvisor Toolkit|CBL-Mariner|Azure Linux) import from Magnus Edenhill Open Source \(license: BSD\)(\.|\n|$)',
    "NVIDIA":                         r'\n-\s+Initial (Edge Microvisor Toolkit|CBL-Mariner|Azure Linux) import from NVIDIA \(license: (ASL 2\.0|GPLv2|BSD)\)(\.|\n|$)',
    "OpenEuler":                      r'\n-\s+Initial (Edge Microvisor Toolkit|CBL-Mariner|Azure Linux) import from OpenEuler \(license: BSD\)(\.|\n|$)',
    "OpenMamba":                      r'\n-\s+Initial (Edge Microvisor Toolkit|CBL-Mariner|Azure Linux) import from OpenMamba(\.|\n|$)',
    "OpenSUSE":                       r'\n-\s+Initial (Edge Microvisor Toolkit|CBL-Mariner|Azure Linux) import from openSUSE \w+ \(license: same as "License" tag\)(\.|\n|$)',
